...
# month = '6' # choose which month to analyze
#
...
participantList = os.listdir(participant_dir)
participant = participantList[2] # choose which particpant to analyze
months = ['2','3','4','5'] # choose which month to analyze
strToSave = '2-5'
...
date_range = (max_date - min_date) / 4

x_ticks = [min_date + i * date_range for i in range(5)]
x_labels = ['Start month 2', 'Start month 3', 'Start month 4', 'Start month 5', 'End month 5']
