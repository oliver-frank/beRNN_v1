...
model_list = [
os.getcwd() + '\BeRNN_models\Model_130_BeRNN_01_Month_2-4',
os.getcwd() + '\BeRNN_models\Model_131_BeRNN_03_Month_2-4',
os.getcwd() + '\BeRNN_models\Model_132_BeRNN_05_Month_2-4'
]
