...
model_list = [
os.getcwd() + '\BeRNN_models\Model_112_BeRNN_01_Month_2-4',
os.getcwd() + '\BeRNN_models\Model_117_BeRNN_03_Month_2-4',
os.getcwd() + '\BeRNN_models\Model_122_BeRNN_05_Month_2-4'
]
