...
# todo: In the very end we need as many trials for each task as we need to train the model to high performance, this could
# todo: potentially be difficult for the 2. wave participants

# todo: After the HP Tuning it might be possible to find the amount of minimum trials needed to have good network performance
# todo: that should be the objective (and not the time of e.g. three months for data collection)
